/**
 * Package-owned invariant companion for `@cimdev/harness/dsh-storage-domain`: every
 ...
 * @module @cimdev/harness/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@cimdev/harness/dsh-storage-domain'
