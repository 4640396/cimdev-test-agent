/**
 * Package-owned invariant companion for `@cimdev/harness/dsh-workspace`.
 * @module @cimdev/harness/dsh-workspace/invariant
 */

import type { Context } from '@cimdev/harness/cordis'
import type { InvariantInstaller } from '@cimdev/harness/dsh-invariants'
import type { DomainChanged } from '@cimdev/harness/dsh-storage-domain'
import { WorkspaceId } from '@cimdev/harness/dsh-workspace'

const PACKAGE_NAME = '@cimdev/harness/dsh-workspace'
