 ...
 * domain data form.
 * @module @cimdev/harness/dsh-workspace
 */
...
import type { SessionHeader, SessionId } from '@cimdev/harness/dsh-session'
import type {} from '@cimdev/harness/dsh-session-persistence'
import type { DomainGlobal, KvTable } from '@cimdev/harness/dsh-storage-domain'
