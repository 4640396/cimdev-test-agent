 ...
 * @module @cimdev/harness/dsh-workspace/src/spec
 */

import { z } from 'zod'
import { SessionId } from '@cimdev/harness/dsh-session'
import { defineDomain, domainTable } from '@cimdev/harness/dsh-storage-domain'
