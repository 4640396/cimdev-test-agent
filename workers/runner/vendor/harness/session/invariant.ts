 ...
 * companion beside `@cimdev/harness/dsh-invariants` to enable the checks.
 *
 * @module @cimdev/harness/dsh-session/invariant
 */

import type { Context } from '@cimdev/harness/cordis'
import { assertNever } from '@cimdev/harness/dsh-llm'
import type { CallId } from '@cimdev/harness/dsh-llm'
import type { InvariantFailure, InvariantInstaller } from '@cimdev/harness/dsh-invariants'
import type { Session, SessionEvent } from '@cimdev/harness/dsh-session'
import { TOOL_NOT_STARTED } from './repair.ts'

const PACKAGE_NAME = '@cimdev/harness/dsh-session'
