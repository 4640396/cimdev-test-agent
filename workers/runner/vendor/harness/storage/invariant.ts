/**
 * Package-owned invariant companion for `@cimdev/harness/dsh-storage`.
 * @module @cimdev/harness/dsh-storage/invariant
 */
...
const PACKAGE_NAME = '@cimdev/harness/dsh-storage'
