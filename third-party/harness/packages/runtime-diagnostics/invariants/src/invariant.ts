/**
 * Package-owned invariant companion for `@cimdev/harness/dsh-invariants`.
 * @module @cimdev/harness/dsh-invariants/invariant
 */
...
const PACKAGE_NAME = '@cimdev/harness/dsh-invariants'
