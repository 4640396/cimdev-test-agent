 ...
 * @module @cimdev/harness/dsh-sandbox-local
 */
...
} from '@cimdev/harness/node-addon-landlock-run'
import { Context } from '@cimdev/harness/cordis'
import z from '@cimdev/harness/schemastery'
import { assertNever } from '@cimdev/harness/dsh-llm'
import { SandboxProvider, SandboxUnavailableError } from '@cimdev/harness/dsh-sandbox'
import type { ConfinedArgv, ConfinedSandboxMode, RunnerFailureRule, SandboxEnforcement, SandboxPolicy } from '@cimdev/harness/dsh-sandbox'
import type { SessionId } from '@cimdev/harness/dsh-session'
import { AclWriteGrant, assertTempRootOutsideWorkspace, tempWriteSid, workspaceWriteSid } from '@cimdev/harness/dsh-sandbox-windows-acl'
...
const PLATFORM_CHAINS: Record<string, readonly SelectedRunner['runner'][]> = {
  ...
  darwin: ['seatbelt'],
  // The Windows restricted-token runner (@cimdev/harness/dsh-sandbox-windows-acl):
