...
import { LAUNCHER_FAILURE_EXIT } from '@cimdev/harness/node-addon-landlock-run'
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@cimdev/harness/dsh-sandbox'
import type { SandboxPolicy } from '@cimdev/harness/dsh-sandbox'
import {
  LocalSandboxProvider,
} from '@cimdev/harness/dsh-sandbox-local'
import type { Config } from '@cimdev/harness/dsh-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @cimdev/harness/dsh-sandbox-windows-acl/tests/provider-chain.spec.ts
