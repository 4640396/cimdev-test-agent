...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@cimdev/harness/dsh-llm'
import type { AppIdentity } from '@cimdev/harness/dsh-llm'
...
describe('userAgent', () => {
  it('renders product/version with the +url comment', () => {
    expect(userAgent()).toBe(
      `harness/${manifest.version} (+https://github.com/deepseek-ai/harness)`,
    )
  })
