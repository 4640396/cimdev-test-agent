 ...
 * diagnostics.
 *
 * The `Branded<B>` primitive itself lives in `@cimdev/harness/dsh-brand` (a
 ...
 *
 * @module @cimdev/harness/dsh-llm/brand
 */

import type { Branded } from '@cimdev/harness/dsh-brand'
