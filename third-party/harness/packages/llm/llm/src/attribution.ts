 ...
 * @module @cimdev/harness/dsh-llm/attribution
 */

// Local patch: the vendored package is not installed as a node module, so its
// own package.json is not resolvable from the bundled output. Pin the vendored
// version instead.
