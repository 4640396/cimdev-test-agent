...
import { bindScopeParent, carrierKeyOf, createScope, isScopeCarrier, scopeChainOf, scopeOf, scopeParentOf, scopeTarget } from '@cimdev/harness/dsh-scope'
import type { Scope, Scoped } from '@cimdev/harness/dsh-scope'
