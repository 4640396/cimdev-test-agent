import { freezeMessage, MessageId } from '@cimdev/harness/dsh-llm'
import { describe, expect, it } from 'vitest'
import { Context } from '@cimdev/harness/cordis'
import type { Events } from '@cimdev/harness/cordis'
import type { Agent } from '@cimdev/harness/dsh-agent'
import { scopeTarget } from '@cimdev/harness/dsh-scope'
import * as ScopeInvariant from '@cimdev/harness/dsh-scope/invariant'
import InvariantRegistry from '@cimdev/harness/dsh-invariants'
