/** Package-owned scoped-dispatch invariants. @module @cimdev/harness/dsh-scope/invariant */

import type { Context } from '@cimdev/harness/cordis'
import type { InvariantInstaller } from '@cimdev/harness/dsh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@cimdev/harness/dsh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@cimdev/harness/dsh-scope'
