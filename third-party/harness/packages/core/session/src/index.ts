 ...
 *
 * @module @cimdev/harness/dsh-session
 */

import { Context, Service } from '@cimdev/harness/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@cimdev/harness/dsh-llm'
import { scopeOf, scopeTarget } from '@cimdev/harness/dsh-scope'
import type { Scoped } from '@cimdev/harness/dsh-scope'
import type { Message } from '@cimdev/harness/dsh-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@cimdev/harness/dsh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@cimdev/harness/dsh-llm'
...
declare module '@cimdev/harness/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@cimdev/harness/dsh-scope`): agent-scoped listeners
     ...
     * Scope-filtered dispatch (`@cimdev/harness/dsh-scope`) reuses the owner scope.
     ...
     * (`@cimdev/harness/dsh-scope`) reuses the session's owner scope.
...
declare module '@cimdev/harness/dsh-typert-protocol' {
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@cimdev/harness/dsh-session#Session',
        wireTypeSymbol: '@cimdev/harness/dsh-session/types#SessionId',
