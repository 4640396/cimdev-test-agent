...
import type { SessionEvent, SurfaceEvent, SurfaceEventType } from '@cimdev/harness/dsh-session'
import {
  Session,
  SessionId,
  foldSurface,
...
import { SurfaceManager } from '@cimdev/harness/dsh-session/surface'
import {
  createMessage,
