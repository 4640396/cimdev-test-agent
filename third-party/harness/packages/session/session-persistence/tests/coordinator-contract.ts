import { createUserMessage } from '@cimdev/harness/dsh-llm'
/**
 ...
 * @module @cimdev/harness/dsh-session-persistence/tests/coordinator-contract
 */

import { describe, expect, it, vi } from 'vitest'
import { Context, type Fiber } from '@cimdev/harness/cordis'
import { scopeTarget } from '@cimdev/harness/dsh-scope'
import SessionStore, { SESSION_FORMAT_VERSION, Session, SessionId } from '@cimdev/harness/dsh-session'
import type { SessionEvent } from '@cimdev/harness/dsh-session'
