 ...
 * @module @cimdev/harness/dsh-session-persistence
 */

import { Context, Service } from '@cimdev/harness/cordis'
import { SessionPreparation } from '@cimdev/harness/dsh-session'
import type { SessionEvent, SessionId, SessionHeader } from '@cimdev/harness/dsh-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@cimdev/harness/dsh-session'
