import { MessageId, createUserMessage, createMessage } from '@cimdev/harness/dsh-llm'
...
import type { Session, SessionEvent, SessionHeader } from '@cimdev/harness/dsh-session'
...
describe('JsonlSessionPersistence: format helpers', () => {
  ...
  it('projectKey normalizes project paths into bounded readable names', () => {
    expect(projectKey('/Users/qyj/work/harness')).toBe('--Users-qyj-work-harness--')
