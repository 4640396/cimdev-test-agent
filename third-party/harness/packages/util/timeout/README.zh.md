...
```ts
import { clampTimeout, deadline, idleWatchdog, MAX_TIMER_DELAY_MS, timeoutOf, TimeoutReason } from '@cimdev/harness/dsh-timeout'
```
...
```ts
import { deadline, timeoutOf } from '@cimdev/harness/dsh-timeout'
