...
The Cordis framework and its foundation libraries are source-vendored into this repository rather than consumed from npm, and republished under the `@cimdev/harness` scope. All are MIT-licensed; each directory preserves its upstream `LICENSE` file. Exact upstream commits and local modifications are recorded in [`vendor/README.md`](vendor/README.md).

| Package | Upstream name | Upstream | License |
| --- | --- | --- | --- |
| `@cimdev/harness/cosmokit` | `cosmokit` | [github.com/harness/cosmokit](https://github.com/harness/cosmokit) | MIT |
| `@cimdev/harness/schemastery` | `schemastery` | [github.com/harness/schemastery](https://github.com/harness/schemastery) | MIT |
| `@cimdev/harness/cordis` | `cordis` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@cimdev/harness/cordis-plugin-loader` | `@cordisjs/plugin-loader` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@cimdev/harness/cordis-plugin-include` | `@cordisjs/plugin-include` | [github.com/harness/cordis](https://github.com/harness/cordis) | MIT |
| `@cimdev/harness/cordis-plugin-group` | `@cordisjs/plugin-group` | [github.com/harness/cordis](https://github.com/harness/cordis) | MIT |
| `@cimdev/harness/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [github.com/harness/cordis](https://github.com/harness/cordis) | MIT |
| `@cimdev/harness/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [github.com/harness/cordis](https://github.com/harness/cordis) | MIT |
| `@cimdev/harness/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [github.com/harness/cordis](https://github.com/harness/cordis) | MIT |
...
| [`pydantic`](https://github.com/pydantic/pydantic) | MIT | runtime dependency of `harness-sdk` |
...
`@cimdev/harness/node-addon-landlock-run` (and its platform packages) is built and released from this repository under BSD 3-Clause. It is listed here for completeness; it is first-party, not third-party.
